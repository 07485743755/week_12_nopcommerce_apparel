...
public class Apparel extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@id='Email']"), "aliza123@yahoo.com");
        sendTextToElement(By.xpath("//input[@id='Password']"), "a12345");
        ...
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_PhoneNumber']"), "07896543219");
